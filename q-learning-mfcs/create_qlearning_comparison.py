...
fig.suptitle(
    "Q-Learning vs PID Substrate Control Comparison",
    fontsize=16,
    fontweight="bold",
)
...
ax1.plot(
    qlearning_data["time_hours"],
    qlearning_data["reservoir_concentration"],
    label="Q-Learning Controller",
    color="blue",
    linewidth=2,
    alpha=0.8,
)
...
ax2.plot(
    qlearning_data["time_hours"],
    qlearning_data["total_power"] * 1000,
    label="Q-Learning Controller",
    color="blue",
    linewidth=2,
    alpha=0.8,
...
ax3.plot(
    qlearning_data["time_hours"],
    qlearning_data["substrate_addition_rate"],
    label="Q-Learning Controller",
    color="blue",
    linewidth=2,
    alpha=0.8,
...
ql_total_added = (
    qlearning_data["substrate_addition_rate"].sum() * 0.00278
)  # Convert to total mmol
...
plt.tight_layout()
plt.savefig(
    "data/figures/qlearning_vs_pid_comparison.png",
    dpi=300,
    bbox_inches="tight",
)
