...
def load_and_prepare_data():
    ...
    try:
        ...
        non_unified_df = pd.read_csv(
            get_simulation_data_path("mfc_qlearning_20250724_022231.csv"),
        )
        recirculation_df = pd.read_csv(
            get_simulation_data_path("mfc_recirculation_control_20250724_040215.csv"),
        )  # 1000h data
    ...
    unified_df["avg_biofilm"] = unified_df[
        [
            "cell_1_biofilm",
            "cell_2_biofilm",
            "cell_3_biofilm",
    ...
    non_unified_df["avg_biofilm"] = non_unified_df[
        [
            "cell_1_biofilm",
            "cell_2_biofilm",
            "cell_3_biofilm",
    ...
    recirculation_df["avg_biofilm"] = recirculation_df[
        [
            "cell_1_biofilm",
            "cell_2_biofilm",
            "cell_3_biofilm",
    ...
    if "substrate_utilization" not in unified_df.columns:
        ...
        unified_df["substrate_utilization"] = np.maximum(
            0,
    ...
    if "substrate_utilization" not in recirculation_df.columns:
        ...
        recirculation_df["substrate_utilization"] = np.maximum(
            0,
            100
            * (
                recirculation_df["reservoir_concentration"]
                - recirculation_df["outlet_concentration"]
            )
            / recirculation_df["reservoir_concentration"],
        )
...
def create_biofilm_health_comparison(unified_df, non_unified_df, recirculation_df):
    ...
    fig.suptitle(
        "Biofilm Health Comparison: Three MFC Models",
        fontsize=16,
        fontweight="bold",
    )
    ...
    ax1.plot(
        unified_100h["time_hours"],
        unified_100h["avg_biofilm"],
        label="Unified (STARVED)",
        color="red",
        linewidth=2,
        linestyle="--",
    )
    ax1.plot(
        non_unified_100h["time_hours"],
        non_unified_100h["avg_biofilm"],
        label="Non-Unified",
        color="blue",
        linewidth=2,
    )
    ax1.plot(
        recirculation_df["time_hours"],
        recirculation_df["avg_biofilm"],
        label="Recirculation (BREAKTHROUGH)",
        color="green",
        linewidth=3,
    )
    ...
    ax3.axhline(
        y=recirculation_df["avg_biofilm"].iloc[-1],
        color="green",
        linestyle=":",
        alpha=0.8,
        label=f"Average ({recirculation_df['avg_biofilm'].iloc[-1]:.3f})",
    )
    ...
    unified_100h["health_score"] = 100 * (
        1 - np.abs(unified_100h["avg_biofilm"] - optimal_thickness) / optimal_thickness
    )
    non_unified_100h["health_score"] = 100 * (
        1
        - np.abs(non_unified_100h["avg_biofilm"] - optimal_thickness)
        / optimal_thickness
    )
    recirculation_df["health_score"] = 100 * (
        1
        - np.abs(recirculation_df["avg_biofilm"] - optimal_thickness)
        / optimal_thickness
    )

    ax4.plot(
        unified_100h["time_hours"],
        unified_100h["health_score"],
        label="Unified (STARVED)",
        color="red",
        linewidth=2,
        linestyle="--",
...
def create_substrate_management_comparison(
    unified_df,
    non_unified_df,
    recirculation_df,
):
    ...
    fig, axes = plt.subplots(2, 2, figsize=(16, 12))
    fig.suptitle(
        "Substrate Management Comparison: Three MFC Models",
        fontsize=16,
        fontweight="bold",
    )
    ...
    ax1.plot(
        unified_100h["time_hours"],
        unified_100h["substrate_utilization"],
        label="Unified (FAILED)",
        color="red",
        linewidth=2,
        linestyle="--",
    )
    ax1.plot(
        non_unified_100h["time_hours"],
        non_unified_100h["substrate_utilization"],
        label="Non-Unified",
        color="blue",
        linewidth=2,
    )
    ax1.plot(
        recirculation_df["time_hours"],
        recirculation_df["substrate_utilization"],
        label="Recirculation (OPTIMAL)",
        color="green",
        linewidth=3,
    )
    ...
    ax2.axhline(
        ...
        linestyle="--",
        linewidth=2,
        label="Starvation Threshold (5.0)",
    )
    ax2.axhline(
        y=np.mean(cell_concentrations),
        color="green",
        linestyle=":",
        alpha=0.8,
        label=f"Average ({np.mean(cell_concentrations):.1f})",
    )
...
def create_system_performance_comparison(unified_df, non_unified_df, recirculation_df):
    ...
    fig, axes = plt.subplots(2, 2, figsize=(16, 12))
    fig.suptitle(
        "System Performance Comparison: Three MFC Models",
        fontsize=16,
        fontweight="bold",
    )
    ...
    non_unified_power = non_unified_100h.get(
        "stack_power",
        non_unified_100h.get("total_power", 0),
    )
    ...
    non_unified_flow = non_unified_100h.get(
        "flow_rate_ml_h",
        non_unified_100h.get("flow_rate", 10),
    )
    ...
    for i, metric in enumerate(metrics):
        table_data.append(
            [metric, unified_values[i], non_unified_values[i], recirculation_values[i]],
        )
...
def create_breakthrough_analysis_plot(unified_df, non_unified_df, recirculation_df):
    ...
    fig, axes = plt.subplots(2, 2, figsize=(16, 12))
    fig.suptitle(
        "🏆 BREAKTHROUGH: Biofilm Starvation Prevention System",
        fontsize=16,
        fontweight="bold",
    )
    ...
    ax2.plot(
        ...
        color="green",
        linewidth=4,
        label="Recirculation System - SUCCESS",
    )
    ax2.axhline(
        y=1.3,
        color="gold",
    ...
    time_samples = recirculation_df["time_hours"][
        :: len(recirculation_df) // 10
    ]  # Sample points

    for i in range(1, 6):
        cell_data = recirculation_df[f"cell_{i}_concentration"][
            :: len(recirculation_df) // 10
        ]
        ax3.plot(
            time_samples,
...
def main() -> None:
    ...
    fig1 = create_biofilm_health_comparison(
        unified_df,
        non_unified_df,
        recirculation_df,
    )
    fig1.savefig(
        get_figure_path("biofilm_health_comparison_1000h.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig1)
    ...
    fig2 = create_substrate_management_comparison(
        unified_df,
        non_unified_df,
        recirculation_df,
    )
    fig2.savefig(
        get_figure_path("substrate_management_comparison_1000h.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig2)
    ...
    fig3 = create_system_performance_comparison(
        unified_df,
        non_unified_df,
        recirculation_df,
    )
    fig3.savefig(
        "figures/system_performance_comparison_1000h.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig3)
    ...
    fig4 = create_breakthrough_analysis_plot(
        unified_df,
        non_unified_df,
        recirculation_df,
    )
    fig4.savefig(
        "figures/breakthrough_analysis_1000h.png",
        dpi=300,
        bbox_inches="tight",
    )
    plt.close(fig4)
