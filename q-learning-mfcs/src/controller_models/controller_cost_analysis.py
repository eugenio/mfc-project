...
class ControllerCostAnalyzer:
    ...
    def __init__(self, system_specs: ControllerSystemSpecs) -> None:
    ...
    def _initialize_standard_costs(self) -> None:
        ...
        # Development costs
        development_cost = (
            self.system_specs.development_person_months * self.engineer_cost_per_month
        )
        ...
        testing_cost = (
            self.system_specs.testing_person_months * self.engineer_cost_per_month
        )
        ...
        documentation_cost = (
            self.system_specs.documentation_person_months * self.engineer_cost_per_month
        )
    ...
    def _initialize_power_requirements(self) -> None:
        ...
        self.add_power_requirement(
            PowerRequirement(
                ...
                efficiency=0.90,
                thermal_dissipation_w=self.system_specs.real_time_controller_overhead_w
                * 0.25,
            ),
        )
        ...
        self.add_power_requirement(
            PowerRequirement(
                ...
                peak_power_w=self.system_specs.communication_power_w
                * 2.0,  # High peak for transmission
        ...
        self.add_power_requirement(
            PowerRequirement(
                ...
                peak_power_w=self.system_specs.cooling_power_w
                * 1.0,  # No peak for fans
    ...
    def add_cost_item(self, cost_item: CostItem) -> None:
        """Add a cost item to the analysis."""
        self.cost_items.append(cost_item)

    def add_power_requirement(self, power_req: PowerRequirement) -> None:
    ...
    def calculate_total_power_requirements(self) -> dict[str, float]:
        ...
        for req in self.power_requirements:
            ...
            avg_power = (
                req.idle_power_w * (100 - req.duty_cycle_pct) / 100
    ...
    def calculate_cost_analysis(self, analysis_years: int = 10) -> dict[str, Any]:
        ...
        category_costs = {
            category: {"initial": 0.0, "recurring": 0.0, "total": 0.0}
        ...
        for item in self.cost_items:
            ...
            total_item_cost = (
                item.initial_cost + total_recurring * analysis_years + replacement_cost
            )
        ...
        annual_energy_cost = (
            power_analysis["average_system_power_w"]
            / 1000.0
            * 8760
        ...
        operational_cost_per_year = (
            annual_energy_cost + self.facility_cost_per_month * 12
        )
        total_recurring_cost_per_year += operational_cost_per_year

        # Calculate total cost of ownership
        total_cost_of_ownership = (
            total_initial_cost + total_recurring_cost_per_year * analysis_years
        )

        # Calculate cost per unit metrics
        annual_operating_hours = 8760  # 24/7 operation
        cost_per_operating_hour = total_cost_of_ownership / (
            analysis_years * annual_operating_hours
        )
    ...
    def generate_cost_report(self, analysis_years: int = 10) -> str:
        ...
        report.append(
            f"System Lifetime: {self.system_specs.expected_lifetime_years} years",
        )
        report.append("")
        ...
        report.append("-" * 20)
        report.append(
            f"Total Initial Investment: ${analysis['total_initial_cost']:,.2f}",
        )
        report.append(
            f"Annual Operating Cost: ${analysis['total_recurring_cost_per_year']:,.2f}",
        )
        report.append(
            f"Total Cost of Ownership: ${analysis['total_cost_of_ownership']:,.2f}",
        )
        report.append(
            f"Cost per Operating Hour: ${analysis['cost_per_operating_hour']:.4f}",
        )
        report.append("")
        ...
        report.append(
            f"Active Power Consumption: {power_req['total_active_power_w']:.1f} W",
        )
        report.append(
            f"Idle Power Consumption: {power_req['total_idle_power_w']:.1f} W",
        )
        report.append(
            f"Average Power Consumption: {power_req['average_system_power_w']:.1f} W",
        )
        report.append(
            f"Thermal Dissipation: {power_req['total_thermal_dissipation_w']:.1f} W",
        )
        report.append(
            f"Annual Energy Consumption: {power_req['average_system_power_w'] * 8760 / 1000:.1f} kWh",
        )
        ...
        high_cost_items = [
            name
            for name, details in analysis["item_details"].items()
        ...
        high_power_components = [
            comp
            for comp, details in power_req["component_breakdown"].items()
    ...
    def compare_configurations(
        self,
        other_analyzer: "ControllerCostAnalyzer",
        ...
        return {
            "configuration_a": {
                ...
                "average_power_w": analysis_a["power_requirements"][
            ...
            "configuration_b": {
                ...
                "average_power_w": analysis_b["power_requirements"][
                    "average_system_power_w"
                ],
            },
            "differences": {
                "total_cost_diff": analysis_b["total_cost_of_ownership"]
                - analysis_a["total_cost_of_ownership"],
                "initial_cost_diff": analysis_b["total_initial_cost"]
                - analysis_a["total_initial_cost"],
                "annual_cost_diff": analysis_b["total_recurring_cost_per_year"]
                - analysis_a["total_recurring_cost_per_year"],
                "power_diff_w": (
                    analysis_b["power_requirements"]["average_system_power_w"]
