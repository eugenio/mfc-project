...
class MFCLiteratureDatabase:
    ...
    def _build_physics_validations(self):
        ...
        self.parameter_validations['fluid_density'] = ParameterValidation(
            ...
            literature_refs=[self.references['logan2006'], self.references['torres2010']],
            experimental_conditions=['25°C, water', '30°C, growth medium', '20°C, PBS buffer'],
        ...
        self.parameter_validations['dynamic_viscosity'] = ParameterValidation(
            ...
            literature_refs=[self.references['logan2006'], self.references['kiely2011']],
            experimental_conditions=['25°C, water', '30°C, growth medium', '20°C, growth medium'],
            validation_status='validated',
        ...
        self.parameter_validations['substrate_diffusivity'] = ParameterValidation(
            ...
            literature_refs=[self.references['torres2010'], self.references['logan2006']],
            experimental_conditions=['Lactate in water, 25°C', 'Acetate in medium, 30°C', 'Glucose in PBS, 25°C'],
            validation_status='validated',
        ...
        self.parameter_validations['electrode_permeability'] = ParameterValidation(
            ...
            literature_refs=[self.references['kiely2011'], self.references['logan2006']],
            experimental_conditions=['Carbon felt', 'Graphite plate', 'Carbon cloth', 'Graphite granules'],
            validation_status='validated',
    ...
    def _build_biofilm_validations(self):
        ...
        self.parameter_validations['max_biofilm_density'] = ParameterValidation(
            ...
            literature_refs=[self.references['kiely2011'], self.references['reguera2005'], self.references['torres2010']],
            experimental_conditions=['Geobacter biofilm', 'Shewanella biofilm', 'Mixed culture', 'Mature biofilm (>30 days)'],
            validation_status='validated',
        ...
        self.parameter_validations['biofilm_yield'] = ParameterValidation(
            ...
            literature_refs=[self.references['pinchuk2010'], self.references['torres2010']],
            experimental_conditions=['Lactate substrate', 'Acetate substrate', 'Glucose substrate', 'Anaerobic conditions'],
            validation_status='validated',
        ...
        self.parameter_validations['decay_rate'] = ParameterValidation(
            ...
            literature_refs=[self.references['kiely2011'], self.references['logan2006']],
            experimental_conditions=['Steady-state biofilm', 'Fed-batch operation', 'Continuous operation'],
            validation_status='validated',
        ...
        self.parameter_validations['detachment_rate'] = ParameterValidation(
            ...
            literature_refs=[self.references['kiely2011'], self.references['torres2010']],
            experimental_conditions=['Low shear', 'Medium shear', 'High shear conditions'],
            validation_status='validated',
    ...
    def _build_metabolic_validations(self):
        ...
        self.parameter_validations['max_growth_rate'] = ParameterValidation(
            ...
            literature_refs=[self.references['pinchuk2010'], self.references['liu2022']],
            experimental_conditions=['Lactate, anaerobic', 'Optimal conditions', 'Laboratory conditions'],
            validation_status='validated',
        ...
        self.parameter_validations['max_lactate_uptake'] = ParameterValidation(
            ...
            literature_refs=[self.references['pinchuk2010'], self.references['coursolle2010']],
            experimental_conditions=['Saturating lactate', 'Optimal pH', 'Anaerobic conditions'],
            validation_status='validated',
        ...
        self.parameter_validations['michaelis_constant'] = ParameterValidation(
            ...
            literature_refs=[self.references['torres2010'], self.references['coursolle2010']],
            experimental_conditions=['Lactate substrate', 'Various temperatures', 'pH 7.0'],
            validation_status='validated',
    ...
    def _build_electrochemical_validations(self):
        ...
        self.parameter_validations['flavin_transfer_efficiency'] = ParameterValidation(
            ...
            literature_refs=[self.references['marsili2008'], self.references['coursolle2010']],
            experimental_conditions=['Riboflavin present', 'Optimal electrode potential', 'pH 7.0'],
            validation_status='validated',
        ...
        self.parameter_validations['max_current_density'] = ParameterValidation(
            ...
            literature_refs=[self.references['logan2006'], self.references['marsili2008'], self.references['torres2010']],
            experimental_conditions=['Shewanella MFC', 'Optimized conditions', 'Laboratory scale'],
            validation_status='validated',
        ...
        self.parameter_validations['electrode_potential'] = ParameterValidation(
            ...
            literature_refs=[self.references['marsili2008'], self.references['torres2010']],
            experimental_conditions=['Flavin-mediated transfer', 'Optimal performance', 'pH 7.0'],
            validation_status='validated',
        ...
        self.parameter_validations['coulombic_efficiency'] = ParameterValidation(
            ...
            literature_refs=[self.references['logan2006'], self.references['torres2010']],
            experimental_conditions=['Shewanella MFC', 'Various substrates', 'Laboratory conditions'],
            validation_status='validated',
