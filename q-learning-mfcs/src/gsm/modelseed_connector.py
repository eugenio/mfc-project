...
class ModelSEEDConnector:
    ...
    def search_models(self, organism_name: Optional[str] = None,
    ...
    def load_model_from_modelseed(self, model_id: str) -> Optional[COBRAModelWrapper]:
        """
        ...
        try:
            ...
            wrapper.model_metadata = {
                ...
                'source': 'ModelSEED',
                'description': f'Model loaded from ModelSEED database'
            }
    ...
    def get_reaction_database(self, pathway_filter: Optional[str] = None) -> List[ModelSEEDReaction]:
        """
    ...
    def create_community_model(self, model_ids: List[str],
                             community_id: str = "mfc_community") -> Optional[COBRAModelWrapper]:
        """
...
def setup_mfc_community_from_modelseed(organism_list: Optional[List[str]] = None) -> Optional[COBRAModelWrapper]:
    """
