...
def create_simulation_results_page(pdf) -> None:
...
def create_energy_analysis_page(pdf) -> None:
...
def create_conclusions_page(pdf) -> None:
    ...
    cta_rect = patches.FancyBboxPatch(
        (0.1, 0.02),
        0.8,
        0.15,
        boxstyle="round,pad=0.02",
    ...
    ax_research.text(
        0.5,
        0.05,
        "We welcome partnerships with academic institutions, industry partners, and funding agencies",
        ha="center",
        va="center",
        fontsize=11,
        style="italic",
...
def create_appendix_page(pdf) -> None:
    ...
    contact_rect = patches.FancyBboxPatch(
        (0.05, 0.15),
        0.9,
        0.15,
        boxstyle="round,pad=0.02",
...
def main() -> None:
    ...
    with PdfPages(filename) as pdf:
        ...
        d["Subject"] = (
            "Autonomous microbial fuel cell control using reinforcement learning"
        )
        d["Keywords"] = (
            "MFC, Q-learning, GPU acceleration, energy sustainability, bioelectrochemical"
        )
