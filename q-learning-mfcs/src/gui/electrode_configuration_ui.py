...
class ElectrodeConfigurationUI:
    ...
    def _display_material_properties(
        self,
    ...
    def render_geometry_selector(
        self,
        electrode_type: str = "anode",
    ) -> tuple[ElectrodeGeometry, dict[str, float]]:
            ...
            with col1:
                dimensions["length"] = (
                    st.number_input(
                        ...
                        value=5.0,
                        step=0.1,
                        key=f"{electrode_type}_length",
                        help="Electrode length in cm",
                    )
                    / 100
                )  # Convert to meters
                ...
                dimensions["width"] = (
                    st.number_input(
                        ...
                        value=5.0,
                        step=0.1,
                        key=f"{electrode_type}_width",
                        help="Electrode width in cm",
                    )
                    / 100
                )  # Convert to meters
            ...
            with col2:
                dimensions["thickness"] = (
                    st.number_input(
                        ...
                        value=5.0,
                        step=0.1,
                        key=f"{electrode_type}_thickness",
            ...
            with col1:
                dimensions["diameter"] = (
                    st.number_input(
                        ...
                        value=10.0,
                        step=0.1,
                        key=f"{electrode_type}_diameter",
                        help="Rod diameter in mm",
                    )
                    / 1000
                )  # Convert to meters
            ...
            with col2:
                dimensions["length"] = (
                    st.number_input(
                        ...
                        value=10.0,
                        step=0.1,
                        key=f"{electrode_type}_rod_length",
                        help="Rod length in cm",
                    )
                    / 100
                )  # Convert to meters
            ...
            with col1:
                dimensions["diameter"] = (
                    st.number_input(
                        ...
                        value=15.0,
                        step=0.1,
                        key=f"{electrode_type}_tube_diameter",
                ...
                dimensions["thickness"] = (
                    st.number_input(
                        ...
                        value=1.0,
                        step=0.1,
                        key=f"{electrode_type}_wall_thickness",
            ...
            with col2:
                dimensions["length"] = (
                    st.number_input(
                        ...
                        value=10.0,
                        step=0.1,
                        key=f"{electrode_type}_tube_length",
                        help="Tube length in cm",
                    )
                    / 100
                )  # Convert to meters
            ...
            with col1:
                dimensions["diameter"] = (
                    st.number_input(
                        ...
                        value=20.0,
                        step=0.1,
                        key=f"{electrode_type}_sphere_diameter",
                        help="Sphere diameter in mm",
                    )
                    / 1000
                )  # Convert to meters
            ...
            with col1:
                dimensions["projected_area"] = (
                    st.number_input(
                        ...
                        value=25.0,
                        step=0.01,
                        key=f"{electrode_type}_projected_area",
                        help="Manually specified projected area",
                    )
                    / 10000
                )  # Convert to m²

            with col2:
                dimensions["total_surface_area"] = (
                    st.number_input(
                        ...
                        value=50.0,
                        step=0.01,
                        key=f"{electrode_type}_total_area",
                        help="Manually specified total surface area",
                    )
                    / 10000
                )  # Convert to m²
    ...
    def render_custom_material_properties(
        self,
        electrode_type: str = "anode",
    ) -> MaterialProperties:
    ...
    def calculate_and_display_areas(
        self,
    ...
    def render_electrode_comparison(self) -> None:
    ...
    def render_configuration_summary(
        ...
        with col2:
            ...
            st.write(
                f"**Conductance:** {summary['specific_conductance_S_per_m']:,.0f} S/m",
            )
            st.write(f"**Hydrophobicity:** {summary['hydrophobicity_angle_deg']:.0f}°")

    def render_full_electrode_configuration(
        self,
    ) -> tuple[ElectrodeConfiguration | None, ElectrodeConfiguration | None]:
        """Render complete electrode configuration interface."""
        st.markdown("## ⚡ Electrode Configuration")
        st.markdown(
            "Configure electrode materials, geometry, and properties for accurate MFC modeling.",
        )

        # Tabs for anode and cathode
        anode_tab, cathode_tab, comparison_tab = st.tabs(
            ["🔋 Anode", "🔋 Cathode", "📊 Comparison"],
        )
        ...
        with anode_tab:
            st.markdown(
                "Configure the anode (negative electrode) where microbial oxidation occurs.",
            )
        ...
        with cathode_tab:
            st.markdown(
                "Configure the cathode (positive electrode) where reduction occurs.",
            )
            ...
            if not use_same_as_anode:
                ...
                # Geometry selection
                cathode_geometry, cathode_dimensions = self.render_geometry_selector(
                    "cathode",
                )
