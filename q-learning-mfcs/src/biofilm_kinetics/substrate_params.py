...
class SubstrateParameters:
    ...
    def _load_substrate_parameters(self) -> dict[str, SubstrateProperties]:
        ...
        return {"acetate": acetate_params, "lactate": lactate_params}
    ...
    def get_substrate_properties(self, substrate: str) -> SubstrateProperties:
        ...
        if substrate not in self._substrates:
            ...
            msg = f"Substrate '{substrate}' not recognized. Available: {available}"
            raise ValueError(
                msg,
            )
    ...
    def calculate_nernst_potential(
        ...
        return props.standard_potential - nernst_term * np.log(Q)

    def calculate_theoretical_current(
        self,
        substrate: str,
        ...
        return (props.electrons_per_mole * F * consumption_rate) / 3600
