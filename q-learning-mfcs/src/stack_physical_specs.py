...
def calculate_stack_dimensions():
    ...
    (V_a) ** (1 / 3)  # Side length of cubic chamber (m)
    ...
    2.26 / stack_volume  # Wh/m³ (over 100 hours)
...
def create_stack_diagram() -> None:
    ...
    for i in range(5):
        ...
        cathodic_rect = Rectangle(
            (x + cell_width / 2 + 0.1, 1.5),
            cell_width / 2 - 0.2,
            cell_height - 1,
            facecolor="blue",
            alpha=0.2,
        ...
        ax1.plot(
            [x + cell_width - 0.3, x + cell_width - 0.3],
            [2, 6],
            "gray",
            linewidth=8,
            alpha=0.7,
    ...
    plt.tight_layout()
    plt.savefig(
        get_figure_path("mfc_stack_technical_diagram.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
...
def create_specifications_sheet() -> None:
    ...
    ax.text(
        0.5,
        0.97,
        "MFC Stack Technical Specifications",
        ha="center",
        va="top",
        fontsize=20,
        fontweight="bold",
    ...
    for section in sections:
        ...
        for i, (label, value) in enumerate(section["items"]):
            ...
            ax.text(0.5, item_y, value, fontsize=11, transform=ax.transAxes)
    ...
    ax.text(
        0.5,
        0.01,
        "Generated from 100-hour Q-learning simulation data",
        ha="center",
        va="bottom",
        fontsize=10,
        style="italic",
    ...
    plt.savefig(
        get_figure_path("mfc_stack_specifications.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.close()
