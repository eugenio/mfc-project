...
class LogManager:
    ...
    def create_logger(self, name: str, 
                     ...
                     rotation_config: Optional[LogRotationConfig] = None) -> logging.Logger:
    ...
    def export_logs(self, start_time: Optional[datetime] = None,
                   ...
                   logger_filter: Optional[str] = None) -> List[Dict]:
    ...
    def _parse_log_file(self, log_file: Path, start_time: Optional[datetime],
                       end_time: Optional[datetime], level_filter: Optional[LogLevel],
                       logger_filter: Optional[str]) -> List[Dict]:
    ...
    def create_log_archive(self, archive_name: Optional[str] = None) -> Path:
