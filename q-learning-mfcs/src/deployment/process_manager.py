...
class ProcessManager:
    ...
    def __init__(self, log_dir: str = "/tmp/process-manager-logs"):
        ...
        # Event callbacks
        self.on_process_start: Optional[Callable[[ProcessInfo], None]] = None
        self.on_process_stop: Optional[Callable[[ProcessInfo], None]] = None
        self.on_process_restart: Optional[Callable[[ProcessInfo], None]] = None
        self.on_process_fail: Optional[Callable[[ProcessInfo], None]] = None
