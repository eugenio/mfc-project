...
def send_completion_email(results_file, recipient_email=None) -> None:
...
def setup_email_monitoring(pid_file, log_file) -> None:
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        # Monitor simulation
        pid_file = (
            "/home/uge/mfc-project/q-learning-mfcs/data/logs/1year_simulation.pid"
        )
