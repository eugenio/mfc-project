...
**Supported Backends** (As of July 2025):

- NVIDIA CUDA (via JAX + CuPy integration)  
- AMD ROCm 6.0 (via JAX + ROCm plugin 0.6.0.dev20250728)
- PyTorch fallback (cross-platform GPU support)
- CPU fallback (NumPy with optimized BLAS)
...
1. Add type hints for all methods
1. Create corresponding tests
1. Update module dependency graph
