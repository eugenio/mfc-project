...
- **Mojo 25.4+**: High-performance numerical computations with ROCm/CUDA support
- **JAX 0.6.0 + JAXlib 0.6.0.dev20250728**: Universal GPU acceleration with ROCm plugin
- **PyTorch 2.4+**: Fallback GPU acceleration and neural network operations
- **Streamlit 1.47+**: Real-time web-based GUI interface
...
- **NumPy 2.3.1+/SciPy 1.16.0+**: Advanced numerical computations with BLAS/LAPACK
- **Pandas 2.3.1+**: High-performance data analysis and manipulation
- **Matplotlib 3.10.3+/Plotly 6.2.0+**: Comprehensive scientific visualization
...
1. **Import Errors**: Verify PYTHONPATH and pixi environment
1. **Hook Failures**: Check .claude/settings.json configuration
1. **Performance Issues**: Verify GPU acceleration is active
