...
1. **Standardized Protocols**: Lack of unified measurement standards
1. **Multi-Species Validation**: Most studies focus on single species
1. **Long-Term Stability**: Limited data on sensor drift/calibration
...
1. **"Influence of attached bacteria and biofilm on double-layer capacitance during biofilm monitoring by electrochemical impedance spectroscopy"**

   - PubMed ID: 21762943
   - Reason: Fundamental study on EIS-biofilm interactions

1. **"Long-term monitoring of biofilm growth and disinfection using a quartz crystal microbalance and reflectance measurements"**

   - PubMed ID: 16580080
   - Reason: Combined QCM-optical biofilm thickness validation

1. **"Quantitative analyses of Streptococcus mutans biofilms with quartz crystal microbalance, microjet impingement and confocal microscopy"**
...
1. **Cross-Calibration**: Species-specific calibration curves
1. **Real-Time Validation**: Continuous cross-correlation
1. **Biofilm Control**: Thickness-based feedback control
