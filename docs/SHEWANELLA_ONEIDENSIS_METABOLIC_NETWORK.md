...
3. **Cytochrome d ubiquinol oxidase (Cyd)**
   - Electron acceptor: O₂
...
2. **Cytochrome optimization**: Improved electron transfer chain efficiency
3. **Metabolic pathway redirection**: Increased electron flux to electrode
...
2. **Adaptive central metabolism** with branched TCA cycle under anaerobic conditions  
3. **Sophisticated electron transport network** with multiple terminal oxidases
4. **Flavin-based electron shuttling** enabling efficient extracellular electron transfer
...
2. Liu, J., et al. (2022). Reconstruction of a genome-scale metabolic network for Shewanella oneidensis MR-1. Front. Bioeng. Biotechnol. 10: 913077.

3. Marsili, E., et al. (2008). Shewanella secretes flavins that mediate extracellular electron transfer. PNAS 105(10): 3968-3973.

4. Coursolle, D., et al. (2010). The Mtr respiratory pathway is essential for reducing flavins and electrodes in Shewanella oneidensis. J. Bacteriol. 192(2): 467-474.

5. KEGG Database: Shewanella oneidensis MR-1 (son) - https://www.kegg.jp/kegg-bin/show_organism?org=son