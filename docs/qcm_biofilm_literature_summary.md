...
1. **"Detecting Excess Biofilm Thickness in Microbial Electrolysis Cells"**
...
1. **"Advances in the Mass Sensitivity Distribution of Quartz Crystal Microbalances"**
...
1. **"Real-time monitoring of electrochemically active biofilm"**
...
1. **Viscoelastic corrections**: Necessary for accurate biofilm mass determination
1. **Real-time monitoring**: Current generation is better proxy than total mass
1. **Calibration**: Species-specific calibration required for accurate thickness
1. **Environmental factors**: Temperature, pH, ionic strength affect measurements
