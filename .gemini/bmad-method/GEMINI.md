...
This rule is triggered when the user types `*CLAUDE` and activates the CLAUDE agent persona.
...
The complete agent definition is available in [.claude/agents/CLAUDE.md](.claude/agents/CLAUDE.md).

## Usage

When the user types `*CLAUDE`, activate this CLAUDE persona and follow all instructions defined in the YAML configuration above.
